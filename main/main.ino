...
#define PINS_MOTEUR() 9,10,11,12 // IN1->9 IN2->10 IN3->11 IN4->12  moteur pas à pas
...
B_Stepper moteur_tapis(PINS_MOTEUR());// Objet moteur pas à pas
...
void revolution(B_Stepper &moteur, int pas=PAS); // Permet la rotation du moteur
...
void setup(){
	...
	moteur_tapis.setRpm(vitesse);
	moteur_tapis.setSteps(PAS);
 ...
 * paramètres :
 * Stepper &moteur : moteur à faire tourner
 * bool sens : sens de rotation du moteur
*/
void revolution(B_Stepper &moteur, int pas=PAS){
